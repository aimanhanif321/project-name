  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row lg:h-[525px] items-center lg:justify-around">
        ...
        <div className="bg-[#F9F1E7] w-full lg:w-[393px] h-auto lg:h-[390px] mt-8 lg:mt-0 p-2 rounded-lg flex flex-col items-center justify-center">
          <h1 className="text-center text-[24px] lg:text-[32px] font-semibold mb-6">
            Cart Totals
          </h1>
          <div className="flex items-center justify-around mb-4 w-full px-7 lg:px-0">
            <h3 className="text-sm lg:text-base">Subtotal</h3>
            <span className="text-sm lg:text-base">Rs. 250,000.00</span>
          </div>
          <div className="flex items-center justify-around mb-6 w-full px-4 lg:px-0">
          ...
          <Link href={"/CheckoutPage"}>
            <button className="border border-black w-full lg:w-[222px] h-[48px] lg:h-[58.95px] rounded-2xl text-[18px] lg:text-[20px] hover:text-[#B88E2F]">
              Check Out
            </button>
          </Link>
        </div>
