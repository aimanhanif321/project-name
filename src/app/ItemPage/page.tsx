...
const ItemPage = () => {
    return (
        <>
            {/* Navigation Bar */}
            <nav className="bg-[#F9F1E7] h-24 mt-5 flex items-center gap-8 pl-20">
                <ul className="flex items-center gap-5 list-none">
                    <li className="text-[#9F9F9F]">Home</li>
                    <Image src="/images/left.png" alt="arrow" width={10} height={10} />
            ...
            <div className="flex flex-col lg:flex-row items-start justify-evenly mt-16 px-4 lg:px-24 gap-12">
                ...
                <div className="bg-[#F9F1E7] w-full lg:w-1/2 lg:h-[600px] h-auto flex items-center justify-center p-4 rounded-md">
                    <Image src="/images/sofa.png" alt="sofi" width={500} height={600} className="max-w-full h-[392px]" />
                </div>
                ...
                <div className="flex flex-col max-w-lg">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        <Image src="/images/star.png" alt="star rating" width={124} height={20} />
                  ...
                  <Link href="/ProPage"> <button className="w-52 h-16 bg-transparent text-black rounded-2xl border border-black flex items-center justify-center gap-2 mt-4 sm:mt-0 sm:ml-3">
                           <span>+</span>
                            <span>Compare</span>
                        </button>
                        </Link> 
                    ...
                    <div className="mt-8 flex items-center justify-start gap-8">
                        ...
                        <div className="flex flex-col text-[#9F9F9F]">
                            ...
                            <div className="flex items-center justify-start gap-3">
                                ...
                                <Image src="/images/linkdn.png" alt="in" width={20} height={20} />
                                <Image src="/images/tweet.png" alt="twi" width={20} height={20} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="h-[744px]">
                ...
                <div className="flex flex-col gap-6 sm:flex-row items-center justify-center mt-10">
                    <Image src="/images/item6.png" alt="sofa1" width={605} height={348} />
                    <Image src="/images/item7.png" alt="sofa2" width={605} height={348} />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mx-auto max-w-screen-xl mt-8">
                ...
                <div className="w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center">
                    <Image src="/images/pro1.png" alt="table-img" width={285} height={301} />
                ...
                <div className="w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center">
                    <Image src="/images/pro2.png" alt="table-img" width={285} height={301} />
                ...
                <div className="w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center">
                    <Image src="/images/pro3.png" alt="table-img" width={285} height={301} />
                ...
                <div className="w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center">
                    <Image src="/images/pro4.png" alt="table-img" width={285} height={301} />
