...
const ProductPage = () => {
  return (
    <>
      ...
      <div className="flex  items-center justify-between mt-8 gap-[100px] px-4 pl-20">
        {/* Text Section */}
        <div className="flex flex-col gap-10 mb-6 sm:mb-0 w-full sm:w-1/2">
        ...
        {/* Product Cards */}
        <div className="flex w-full sm:w-1/2 justify-between gap-14">
          {/* Product Card 1 */}
          ...
          <div className="flex  flex-col  sm:mb-0 w-full mt-7 sm:w-1/2">
            <Image
              src="/images/item1.png"
              alt="sec1"
              width={280}
      ...
      <div className="flex flex-wrap items-start justify-between mt-14 w-full px-4 ml-20">
        {/* General Details */}
      ...
      {/* Product Details */}
      <div className="flex flex-wrap items-start justify-between mt-14 w-full ml-20 px-4">
        {/* Labels */}
        <div className="flex flex-col gap-6 text-[18px] sm:text-[20px] w-full sm:w-1/3 mb-6 sm:mb-0">
     ...
     {/* Warranty Details */}
<div className="flex flex-wrap items-start justify-between mt-14 sm:text-[20px] text-[18px] ml-20 sm:px-6 px-4">
